...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case backup.SchemeGroupVersion.WithResource("boshbackuprestores"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Backup().InternalVersion().BOSHBackupRestores().Informer()}, nil
